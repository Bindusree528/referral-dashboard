 ...
 * No external icon library dependency — keeps the project on plain
 * React + CSS as required. Each icon is a tiny functional component
 * that accepts standard SVG props (e.g. className) if ever needed.
 */
